function [nets,err] = geneticTrainNets(input,targets,nGeneration,pop,nLayer1,nLayer2,valData,valTarget,nets)
...
auVal=0;
for g=1:nGeneration
minError = min(netErrors(:,2));
maxError = max(netErrors(:,2));
